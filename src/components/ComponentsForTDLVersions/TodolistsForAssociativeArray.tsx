...
type PropsType = {
    ...
    changeFilter: (weekdaysID: string, value: FilterValuesType) => void
...
export const TodolistsForAssociativeArray = (props: PropsType) => {
    ...
    const setFilters = (filterValue: FilterValuesType) => {
        props.changeFilter(props.weekdaysID, filterValue)
    }
